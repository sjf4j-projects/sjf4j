package org.sjf4j.testbench.path;
...
public class CompiledNavigatorBenchmark {
    ...
    @CompiledNavigator
    public interface CompiledNavigators {
    ...
    public static class GetState {
        ...
        public CompiledNavigators compiled;
        ...
        public void setup() {
            ...
            compiled = CompiledInstances.of(CompiledNavigators.class);
    ...
    @Benchmark
    public String get_color_compiledNavigator(GetState s) {
    ...
    @Benchmark
    public Double get_price_compiledNavigator(GetState s) {
    ...
    @Benchmark
    public Double get_bookPrice_compiledNavigator(GetState s) {
    ...
    @Benchmark
    public Root put_price_compiledNavigator(PutState s) {
        Root root = s.priceRoot;
    ...
    @Benchmark
    public Root put_bookPrice_compiledNavigator(PutState s) {
        Root root = s.bookPriceRoot;
    ...
    @Benchmark
    public Root ensurePut_missing_price_compiledNavigator(EnsureMissingState s) {
        Root root = s.priceRoot;
    ...
    @Benchmark
    public Root ensurePut_missing_bookPrice_compiledNavigator(EnsureMissingState s) {
        Root root = s.bookPriceRoot;
    ...
    @Benchmark
    public Root ensurePutIfAbsent_existing_price_compiledNavigator(EnsureIfAbsentExistingState s) {
        Root root = s.priceRoot;
    ...
    @Benchmark
    public Root ensurePutIfAbsent_existing_bookPrice_compiledNavigator(EnsureIfAbsentExistingState s) {
        Root root = s.bookPriceRoot;
