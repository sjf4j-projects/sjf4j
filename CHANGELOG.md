...
- Added a protected `JsonObject(NodeRegistry.PojoInfo)` constructor for JOJOs that precompute metadata and pass it to `super(...)` on performance-sensitive construction paths.
