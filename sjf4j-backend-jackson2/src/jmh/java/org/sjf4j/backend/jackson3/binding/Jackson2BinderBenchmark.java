...
@Threads(1)
@State(Scope.Thread)
public class Jackson2BinderBenchmark {

    public static void main(String[] args) throws Exception {
        Main.main(new String[]{Jackson2BinderBenchmark.class.getName()});
    }
    ...
    public static class BenchmarkState {
        ...
        public void setup() throws Exception {
            ...
            value = new Document(
                    ...
                    counters(12, 3, 7),
                    null);
            document = mapper.writeValueAsString(value);
    ...
    @Benchmark
    public Document pojo_read_native(BenchmarkState state) throws Exception {
        return state.mapper.readValue(state.document, Document.class);
    }
    ...
    @Benchmark
    public String map_write_native(BenchmarkState state) throws Exception {
        return state.mapper.writeValueAsString(state.mapValue);
    }
