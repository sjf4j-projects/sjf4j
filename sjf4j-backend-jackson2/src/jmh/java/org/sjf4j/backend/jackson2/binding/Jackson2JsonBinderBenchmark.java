...
@Threads(1)
@State(Scope.Thread)
public class Jackson2JsonBinderBenchmark {

    public static void main(String[] args) throws Exception {
        Main.main(new String[]{Jackson2JsonBinderBenchmark.class.getName()});
    }
    ...
    @Benchmark
    public Document readNative(BenchmarkState state) throws Exception {
    ...
    @Benchmark
    public String writeNative(BenchmarkState state) throws Exception {
