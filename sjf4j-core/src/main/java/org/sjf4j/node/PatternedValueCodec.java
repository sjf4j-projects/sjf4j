...
/**
 * Optional interface for {@link NodeValueCodec}s that support date/time format patterns.
 * <p>
 ...
 * pattern during {@link NodeValueCodec#valueToRaw(Object)} encoding and
 * {@link NodeValueCodec#rawToValue(Object)} decoding.
 * <p>
 ...
 */
public interface PatternedValueCodec<V, R> extends NodeValueCodec<V, R> {

    /**
     * Returns a new {@link NodeValueCodec} configured with the given format pattern.
     * <p>
     ...
     */
    NodeValueCodec<V, R> withPattern(String pattern);
