 ...
 *
 * <p>{@code R} is the declared root type and {@code V} is the declared type of the path target.
 * Implementations expose reads through {@link #get(Object)} and may implement mutation methods.
