...
//        assertEquals(Double.class, jo.getObject("height").getClass()); // BigDecimal in Fastjson2
    ...
    @Test public void testOfFactory() {
    ...
    @Test public void testWrapSemantics() {
...
//        assertInstanceOf(JsonObject.class, obj);
    ...
    @Test public void testDefaultValue1() {
        JsonObject jo1 = JsonObject.fromJson("{\"num\":5,\"attr\":{\"aa\":\"bb\"}}");
...
//        assertEquals("cc", jo1.getStringByPath("$.attr.aa2", "cc"));
        ...
        assertEquals(JsonObject.of("aa", "bb"), jo1.getJsonObject("attr"));
    }


    @Test public void testPutMap1() {
        Map<String, Object> map1 = new HashMap<>();
        map1.put("s1", "yesyes");
...
//        JsonObject jo1 = JsonObject.fromJson(json1);
    ...
    @Test public void testEntrySetKeySet() {
    ...
    @Test public void testReadableAndWritableViews() {
    ...
    @Test public void testRemoveByPath() {
    ...
    @Test public void testNodeField1() {
    ...
    @Test public void testSkipNode1() {
        String json =
                "{\n" +
                "  \"id\": 7,\n" +
                "  \"skipObj\": {\n" +
