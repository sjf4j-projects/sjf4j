...
//        List<Object> list = a1.toList();
    ...
    @Test public void testSupplier1() {
        InspectableJsonArray inspectable = new InspectableJsonArray();
        inspectable.add("c");
        assertInstanceOf(ArrayList.class, inspectable.backingList());
    ...
    @Test public void testNegativeIndex() {
