    ...
    public static Object value2Object(Object value, Class<?> objectType) {
        ...
        if (value == null) {
            ...
            if (objectType == null || objectType.isAssignableFrom(JsonObject.class)) {
                ...
                //FIXME: Mixed JsonObject
                return value;
            } else if (PojoRegistry.hasPojo(objectType)) {
...
//    public static Object value2Object333(Object value, Type objectType) {
//        if (ObjectRegistry.hasConverter(objectType)) {
//            return ObjectRegistry.tryValue2Object(value, objectType);
//        }
//
...
//                return Enum.valueOf((Class<? extends Enum>) objectType, value.toString());
//            } else {
//                throw new JsonException("Cannot convert value '" + value.getClass().getName() +
...
//            }
//        } else if (value instanceof JsonObject) {
//            if (objectType == null || objectType.isAssignableFrom(Map.class)) {
//                Map<String, Object> map = new LinkedHashMap<>();
//                ((JsonObject) value).forEach((k, v) -> {
//                    map.put(k, value2Object(v, null));
//                });
//                return map;
//            } else if (JsonObject.class.isAssignableFrom(objectType)) {
//                //FIXME: Mixed JsonObject
...
//                Map<String, Object> map = new LinkedHashMap<>();
//                for (Map.Entry<?, ?> entry : ((Map<?, ?>) value).entrySet()) {
//                    map.put(entry.getKey().toString(), value2Object(entry.getValue(), null));
//                }
//                return map;
//            } else if (JsonObject.class.isAssignableFrom(objectType)) {
//                //FIXME: Mixed JsonObject
...
//            }
//        } else if (value instanceof JsonArray) {
//            if (objectType == null || objectType.isAssignableFrom(List.class)) {
//                List<Object> list = new ArrayList<>();
//                for (Object v : (JsonArray) value) {
//                    list.add(value2Object(v, null));
//                }
//                return list;
//            } else if (objectType.isArray()) {
//                JsonArray ja = (JsonArray) value;
...
//            }
//        } else {
//            throw new JsonException("Unexpected value type '" + value.getClass().getName() + "'");
//        }
//
//    }
