...
public class JacksonStreamingUtil {
    ...
    public static Object readNode(@NonNull JsonParser parser, Type type) throws IOException {
    ...
    public static Object readObject(@NonNull JsonParser parser, Type type) throws IOException {
    ...
    @SuppressWarnings("unchecked")
    public static Object readArray(@NonNull JsonParser parser, Type type) throws IOException {
        Class<?> rawClazz = TypeUtil.getRawClass(type);
        NodeConverter<?, ?> converter = ConverterRegistry.getConverter(rawClazz);
    ...
    public static void writeNode(@NonNull JsonGenerator gen, Object node) throws IOException {
