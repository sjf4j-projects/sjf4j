...
public class SnakeStreamingUtil {
    ...
    public static Object readNode(@NonNull Parser parser, Type type) throws IOException {
    ...
    public static Object readObject(@NonNull Parser parser, Type type) throws IOException {
    ...
    @SuppressWarnings("unchecked")
    public static Object readArray(@NonNull Parser parser, Type type) throws IOException {
        Class<?> rawClazz = TypeUtil.getRawClass(type);
        NodeConverter<?, ?> converter = ConverterRegistry.getConverter(rawClazz);
    ...
    public static void writeNode(@NonNull Emitter emitter, Object node) throws IOException {
