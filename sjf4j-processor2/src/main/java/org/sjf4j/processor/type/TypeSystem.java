...
public final class TypeSystem {
    ...
    /**
     * Resolves Map<K, V>'s readable key type.
     *
     * <p>Raw Map resolves to Object. Wildcards follow readable semantics.</p>
     */
    public TypeMirror mapKeyType(TypeMirror type) {
        if (!isAssignableErasure(
                type,
                mapType)) {
    ...
    /**
     * Compatibility alias for the readable Map value type.
     */
    public TypeMirror mapValueType(TypeMirror type) {
        return mapReadValueType(type);
    }
     ...
     *
     * <p>This is a readable-type API. For writable List access use
     * {@link #listWriteElementType(TypeMirror)}.</p>
     */
    public TypeMirror elementType(TypeMirror type) {
        type = concrete(type);
