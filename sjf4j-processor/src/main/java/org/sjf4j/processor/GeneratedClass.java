...
public final class GeneratedClass {
     ...
     */
    public GeneratedClass(ProcessorContext ctx, TypeElement origin, String postfix, Class<?> generator) {
        this.ctx = ctx;
        this.origin = origin;
    ...
    public void emit() {
        try (SourceWriter out = new SourceWriter(ctx, origin, qualifiedName)) {
            ...
            out.line("");
            out.line("@javax.annotation.processing.Generated(");
            out.indent();
            out.line("value = \"" + generatorName + "\",");
            out.line("comments = \"Generated by SJF4J\"");
            out.dedent();
            out.line(")");
