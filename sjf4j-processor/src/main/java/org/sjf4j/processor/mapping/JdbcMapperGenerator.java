...
public final class JdbcMapperGenerator {
    ...
    private boolean jdbcAnnotationsOnly(ExecutableElement method) {
        for (AnnotationMirror annotation : method.getAnnotationMirrors()) {
            ...
            if (name.equals("org.sjf4j.annotation.mapping.Mapping")
                    || name.equals("org.sjf4j.annotation.mapping.Mappings")
                    || name.equals("org.sjf4j.annotation.mapping.MappingOptions")
                    || name.equals(JdbcMappingOptions.class.getName())
                    || name.equals("org.sjf4j.annotation.mapping.MappingCreator")
                    || name.equals("org.sjf4j.annotation.mapping.MappingCreators")) {
                continue;
            }
            if (name.startsWith("org.sjf4j.annotation.mapping.")) {
